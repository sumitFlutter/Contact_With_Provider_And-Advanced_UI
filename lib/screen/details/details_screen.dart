...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
   ...
   listR= isHidden==false?context.read<Provider1>().contactList:context.read<Provider1>().hiddenContactList;
    listW= isHidden==false?context.watch<Provider1>().contactList:context.watch<Provider1>().hiddenContactList;
